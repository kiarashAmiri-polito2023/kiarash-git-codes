...
function NatNetPollingSample
	...
	for idx = 1 : 10  
		...
		for i = 1:model.RigidBodyCount
			...
			fprintf( 'Z:%0.1fmm  ', data.RigidBodies( i ).z * 1000 )	

			fprintf( 'qx:%0.3frad  ', data.RigidBodies( i ).qx )
			fprintf( 'qy:%0.3frad  ', data.RigidBodies( i ).qy )
			fprintf( 'qz:%0.3frad  ', data.RigidBodies( i ).qz )
