...
function NatNetPollingSample
	...
	natnetclient.HostIP = '192.168.81.17';
	natnetclient.ClientIP = '192.168.81.17';
	...
	for idx = 1 : 100
		...
		for i = 1:model.RigidBodyCount
            ...
            %Pose:
            pose = [data.RigidBodies( i ).x*1000, data.RigidBodies( i ).y*1000, data.RigidBodies( i ).z*1000, phi(1), phi(2), phi(3)];
